...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: AkunSiswaScreen(username: 'Admin'), // sementara pakai static username
    );
  }
}
class AkunSiswaScreen extends StatefulWidget {
  final String username;

  const AkunSiswaScreen({super.key, required this.username});

  @override
  State<AkunSiswaScreen> createState() => _AkunSiswaScreenState();
}

class _AkunSiswaScreenState extends State<AkunSiswaScreen> {
  ...
  void _showTambahDialog() {
    ...
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          title: const Text("Tambah Akun Siswa"),
          content: Column(
  ...
  void _showEditDialog(
    ...
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          title: const Text("Edit Akun Siswa"),
          content: Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              TextField(
        ...
        children: [
          ...
          Expanded(
            child: StreamBuilder<QuerySnapshot>(
              stream: _users.where('role', isEqualTo: 'siswa').snapshots(),
              builder: (context, snapshot) {
                ...
                if (docs.isEmpty) {
                  return const Center(child: Text("Tidak ada akun siswa"));
                }
